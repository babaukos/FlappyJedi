...
public class LevelManager : MonoBehaviour 
{
	...
	private void Update () 
	{
		...
		if (!GameManager.Instance.IsPause()) 
		{
			...
			float div = 50;
			// Vector2 bcgTextOffset = new Vector2(Time.time * (PlayerControl.Instance.GetSpeed()/div * backSpeed), 0);
			// back.material.mainTextureOffset = bcgTextOffset;
	...
	private void SetSizeObjectsSnene()
	{
		...
		face.transform.localScale = new Vector3 (widthBG, 0.5f, 0);
	}
	//
